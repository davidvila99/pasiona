...
namespace MVCZoo.Controllers
{
    public class ItinerariosController : Controller
    {
        ...
        public ItinerariosController(MVCZooContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Còdigo,Duracion,Visitantes,Longitud")] Itinerario itinerario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Còdigo,Duracion,Visitantes,Longitud")] Itinerario itinerario)
        {
            if (id != itinerario.Id)
            {
                return NotFound();
