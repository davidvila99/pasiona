        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Còdigo = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vive_Ens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Vive_Ens_Especies_EspecieId",
                        column: x => x.EspecieId,
                        principalTable: "Especies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vive_Ens_Habitats_HabitatId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vive_Ens_EspecieId",
                table: "Vive_Ens",
                column: "EspecieId");

            migrationBuilder.CreateIndex(
                name: "IX_Vive_Ens_HabitatId",
                table: "Vive_Ens",
                column: "HabitatId");
        }
